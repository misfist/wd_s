...
$id = esc_attr( $args['id'] );
?>
<div class="<?php em_template_classes( 'view-container events' ); ?>" id="em-view-<?php echo $id; ?>" data-view="grid" style="--view-grid-width : <?php echo esc_attr( get_option( 'dbem_event_grid_item_width' ) ); ?>px">
